    ...
    function () {
      ...
      const getFacts = async function () {
        ...
        if (!error) setFacts(facts);
          ...
          alert(
            'Supabase is in sleep mode!😴💤\nWe are extremely sorry! Unable to fetch data at this moment.'
          );
  ...
  return (
    <header className="header">
      ...
      <button
        ...
        onClick={() => setShowForm(currState => !currState)}
      >
  ...
  return (
    <aside>
      ...
      <p className="copyright">
        Built by Vrutik Savla. Copyright © by Jonas Schmedtmann.
      </p>
    </aside>
  );
}
